...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleLogin(Packet1Login par1Packet1Login)
    {
        ...
        this.worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet1Login.gameType, false, par1Packet1Login.hardcoreMode, par1Packet1Login.terrainType, Difficulties.STANDARD), par1Packet1Login.dimension, par1Packet1Login.difficultySetting, this.mc.mcProfiler, this.mc.getLogAgent());
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
    {
        ...
        {
            var8 = EntityList.createEntityOfType(WitherSkullEntity.class, this.worldClient, var2, var4, var6, (double)par1Packet23VehicleSpawn.speedX / 8000.0D, (double)par1Packet23VehicleSpawn.speedY / 8000.0D, (double)par1Packet23VehicleSpawn.speedZ / 8000.0D);
            par1Packet23VehicleSpawn.throwerEntityId = 0;
        }
        ...
        {
            var8 = EntityList.createEntityOfType(FallingBlockEntity.class, this.worldClient, var2, var4, var6, par1Packet23VehicleSpawn.throwerEntityId & 65535, par1Packet23VehicleSpawn.throwerEntityId >> 16);
            par1Packet23VehicleSpawn.throwerEntityId = 0;
        }
        // FCMOD: Added (client only)
        else if ( par1Packet23VehicleSpawn.type == InfiniteArrowEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(InfiniteArrowEntity.class, worldClient, var2, var4, var6 );
        }
        else if ( par1Packet23VehicleSpawn.type == BroadheadArrowEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(BroadheadArrowEntity.class, worldClient, var2, var4, var6 );
        }
        else if ( par1Packet23VehicleSpawn.type == MovingPlatformEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(MovingPlatformEntity.class, worldClient, var2, var4, var6 );
        }
        else if ( par1Packet23VehicleSpawn.type == MovingAnchorEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(MovingAnchorEntity.class, worldClient, var2, var4, var6 );
        }
        else if ( par1Packet23VehicleSpawn.type == RottenArrowEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(RottenArrowEntity.class, worldClient, var2, var4, var6 );
        }
        else if ( par1Packet23VehicleSpawn.type == CorpseEyeEntity.getVehicleSpawnPacketType() )
        {
        	var8 = EntityList.createEntityOfType(CorpseEyeEntity.class, worldClient, var2, var4, var6 );
        }
        // END FCMOD
    ...
    public void handleEntityExpOrb(Packet26EntityExpOrb par1Packet26EntityExpOrb)
    {
        ...
        EntityXPOrb var2 = (EntityXPOrb) EntityList.createEntityOfType(EntityXPOrb.class, worldClient, posX, posY, posZ, 
    		par1Packet26EntityExpOrb.xpValue, par1Packet26EntityExpOrb.notPlayerOwned);
    ...
    public void handleWeather(Packet71Weather par1Packet71Weather)
    {
        ...
        {
            var8 = (LightningBoltEntity) EntityList.createEntityOfType(LightningBoltEntity.class, worldClient, var2, var4, var6 );
        }
    ...
    public void handleFlying(Packet10Flying par1Packet10Flying)
    {
        ...
        if (!this.doneLoadingTerrain)
        {
            ...
            awaitingChunkLoadToDisableGUIScreen = true;
            updatesSinceTerrainLoaded = 0;
        }
    }    
    ...
    public void handleRespawn(Packet9Respawn par1Packet9Respawn)
    {
        if (par1Packet9Respawn.respawnDimension != this.mc.thePlayer.dimension)
        {
            ...
            this.worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet9Respawn.gameType, false, this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled(), par1Packet9Respawn.terrainType, this.mc.theWorld.getWorldInfo().getDifficulty()), par1Packet9Respawn.respawnDimension, par1Packet9Respawn.difficulty, this.mc.mcProfiler, this.mc.getLogAgent());
    ...
    public void handleEntityEffect(Packet41EntityEffect par1Packet41EntityEffect)
    {
        ...
        if (var2 instanceof EntityLiving)
        {
        	...
        	if (par1Packet41EntityEffect.isAmbient > 0 )
        	{
        		bIsAmbient = true;
        	}
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
        ...
        // FCMOD: Added (client only)
        else if (!AddonHandler.interceptCustomClientPacket(this.mc, par1Packet250CustomPayload))
        {
            AddonHandler.clientCustomPacketReceived(this.mc, par1Packet250CustomPayload);
        }
        // END FCMOD
    }
    ...
    // FCMOD: Added (client only)    
    private boolean awaitingChunkLoadToDisableGUIScreen = false;
    private int updatesSinceTerrainLoaded = 0;
    private static final int additionalLoadDelay = 20;
    
    private void updateTerrainLoad()
    {
    	if (awaitingChunkLoadToDisableGUIScreen)
    	{
    		if ( isTerrainAroundPlayerLoaded() )
    		{
    			updatesSinceTerrainLoaded++;
    			
    			// give it an extra second to help smooth things out post load
    			if (updatesSinceTerrainLoaded > additionalLoadDelay)
    			{
		            doneLoadingTerrain = true;
		            mc.displayGuiScreen((GuiScreen)null);
                    awaitingChunkLoadToDisableGUIScreen = false;
    			}
    		}
    		else
    		{
    ...
    public void handlePlayerSync(PlayerSyncPacket packet){
        boolean otherPlayerFoundNearby = false;
        for(int i=0; i< worldClient.playerEntities.size(); i++){
            EntityPlayer otherPlayer = (EntityPlayer)worldClient.playerEntities.get(i);
            EntityPlayer thisPlayer = this.mc.thePlayer;
            if(
                    otherPlayer.username.equals(packet.playerName) &&
                    thisPlayer.getDistanceToEntity(otherPlayer) < 110
            ){
                otherPlayerFoundNearby = true;
            }
        }
        if(!otherPlayerFoundNearby){
            addToSendQueue(packet);
        }
    }
    
    @Override
    public void handleTimerSpeed(TimerSpeedPacket timerSpeedPacket) {
        this.mc.getTimer().setTimerSpeedTarget(timerSpeedPacket.timerSpeed);
        this.mc.thePlayer.setTimerSpeedModifier(timerSpeedPacket.timerSpeed);
    }
    
    @Override
    public void handleHardcoreSpawnSync(HardcoreSpawnPacket hardcoreSpawnPacket) {
        this.mc.thePlayer.setTimeOfLastSpawnAssignment(hardcoreSpawnPacket.timeOfLastSpawnAssignment);
    }
}
