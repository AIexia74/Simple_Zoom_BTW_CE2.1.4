...
public class EntityTrackerEntry
{
    ...
    {
        return par1EntityPlayerMP.getServerForPlayer().getChunkTracker().isChunkWatchedByPlayerAndSentToClient(
        	// client
    ...
    private Packet getPacketForThisEntity()
    {
        ...
        // client
        if ( myEntity instanceof EntityWithCustomPacket)
    	// server
        //if ( trackedEntity instanceof FCIEntityPacketHandler )        	
        {
        	// client
        	EntityWithCustomPacket packetHandler = (EntityWithCustomPacket)myEntity;
        	// server
