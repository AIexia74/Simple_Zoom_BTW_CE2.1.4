...
public class ComponentVillageHall extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        {
        	placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 2, 3, 1, par3StructureBoundingBox);
            placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 2, 1, 0, 
            	this.getMetadataWithOffset(BTWBlocks.woodenDoor.blockID, 1));
        }
        ...
        if ( iAbandonmentLevel <= 1 )
        {
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 6, 3, 4, par3StructureBoundingBox);
