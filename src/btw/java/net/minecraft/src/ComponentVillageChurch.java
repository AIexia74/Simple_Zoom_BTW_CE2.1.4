...
public class ComponentVillageChurch extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        if ( iAbandonmentLevel == 0 )
    	{
            ...
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 2, 4, 7, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 1, 4, 6, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 3, 4, 6, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 2, 4, 5, par3StructureBoundingBox);
    	}
        else
        {
        ...
        {
            int iMetadata = BTWBlocks.ladder.setFacing(0, var4);
            
            placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 3, var5, 3, par3StructureBoundingBox);
        }
        ...
        if ( iAbandonmentLevel == 0 )
        {
            placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 2, 1, 0, 
            	getMetadataWithOffset(BTWBlocks.woodenDoor.blockID, 1));
        }
