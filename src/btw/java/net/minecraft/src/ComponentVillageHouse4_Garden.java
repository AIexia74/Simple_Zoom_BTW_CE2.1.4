...
public class ComponentVillageHouse4_Garden extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        if (this.isRoofAccessible)
        {
            ...
            placeBlockAtCurrentPosition( par1World, BTWBlocks.ladder.blockID, iMetadata, 3, 1, 3, par3StructureBoundingBox );
            placeBlockAtCurrentPosition( par1World, BTWBlocks.ladder.blockID, iMetadata, 3, 2, 3, par3StructureBoundingBox );
            placeBlockAtCurrentPosition( par1World, BTWBlocks.ladder.blockID, iMetadata, 3, 3, 3, par3StructureBoundingBox );
            placeBlockAtCurrentPosition( par1World, BTWBlocks.ladder.blockID, iMetadata, 3, 4, 3, par3StructureBoundingBox );
        }

        if (startPiece.getAbandonmentLevel(par1World) <= 1 )
        {
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 2, 3, 1, par3StructureBoundingBox);
        }
