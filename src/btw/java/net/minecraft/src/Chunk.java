...
public class Chunk
{
    ...
    {
    	for (int iVerticalIndex = closestEntityInfo.chunkEntityListMinVerticalIndex; iVerticalIndex <= closestEntityInfo.chunkEntityListMaxVerticalIndex; iVerticalIndex++ )
    	{
            ...
            {            
            	...
            	while ( entityIterator.hasNext() )
            	{
		        	...
		        	closestEntityInfo.criteria.processEntity(closestEntityInfo, tempEntity);
            	}
            }
    	}
    }
