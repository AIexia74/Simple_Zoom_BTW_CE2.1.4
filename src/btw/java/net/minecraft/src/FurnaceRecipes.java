...
public class FurnaceRecipes
{
    ...
    // FCMOD: Code added
    private Map cookTimeBinaryShiftMap = new HashMap();
    ...
    public void addSmelting( int iInputItemID, ItemStack outputStack, float fExperience, int iCookTimeBinaryShift )
    {
        ...
        cookTimeBinaryShiftMap.put(Integer.valueOf(iInputItemID), Integer.valueOf(iCookTimeBinaryShift));
    }
    
    public int getCookTimeBinaryShift(int iItemID)
    {
    	if ( cookTimeBinaryShiftMap.containsKey(Integer.valueOf(iItemID)) )
    	{
    		return ((Integer) cookTimeBinaryShiftMap.get(Integer.valueOf(iItemID)) ).intValue();
    	}
