...
public class EntityTracker
{
     ...
     */
    public Set trackedEntities = new HashSet();
    ...
    public void addEntityToTracker(Entity par1Entity)
    {
        ...
        // FCMOD: Code added
        else if ( par1Entity instanceof EntityWithCustomPacket)
        {
        	EntityWithCustomPacket fcEntity = (EntityWithCustomPacket)par1Entity;
        ...
        else if (par1Entity instanceof CorpseEyeEntity)
        {
            this.addEntityToTracker(par1Entity, 64, 4, true);
        }
