...
public class WorldClient extends World
{
    ...
    protected LinkedList<ChunkCoordIntPair> prevActiveChunksCoordsList =
    ...
    protected void tickBlocksAndAmbiance()
    {
        ...
        prevActiveChunksCoordsList.retainAll(activeChunksCoordsList);

        if (prevActiveChunksCoordsList.size() == activeChunksCoordsList.size() )
        {
        	prevActiveChunksCoordsList.clear();
        }

        int var1 = 0;
        Iterator var2 = activeChunksCoordsList.iterator();

        while (var2.hasNext())
        {
            ChunkCoordIntPair var3 = (ChunkCoordIntPair)var2.next();

            if ( !prevActiveChunksCoordsList.contains(var3) )
            {
                ...
                this.theProfiler.endSection();
                prevActiveChunksCoordsList.add(var3);
                ++var1;
