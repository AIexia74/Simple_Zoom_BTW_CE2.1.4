...
public class PlayerControllerMP
{
    ...
    public void clickBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (!this.currentGameType.isAdventure() || this.mc.thePlayer.canCurrentToolHarvestBlock(par1, par2, par3))
        {
            ...
            else if (!this.isHittingBlock || !this.sameToolAndBlock(par1, par2, par3))
            {
                ...
                netClientHandler.addToSendQueue( new StartBlockHarvestPacket( par1, par2, par3, par4, fMiningSpeedModifier ) );
    ...
    public boolean onPlayerRightClick(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3)
    {
        ...
        boolean var12 = false;
        int lookedAtBlockID = 0;

        if (!par1EntityPlayer.isSneaking() || par1EntityPlayer.getHeldItem() == null)
        {
            lookedAtBlockID = par2World.getBlockId(par4, par5, par6);
        ...
        Block lookedAtBlock = Block.blocksList[lookedAtBlockID];
        ...
        */        
        if (!var12 && par3ItemStack != null &&
        	!par3ItemStack.getItem().canItemBeUsedByPlayer(par2World, par4, par5, par6, par7, par1EntityPlayer, par3ItemStack))
        {
        	return false;
        }
        else if (lookedAtBlock != null && !lookedAtBlock.canBlocksBePlacedAgainstThisBlock(par2World, par4, par5, par6)) {
            return false;
        }
        ...
        {
            lookedAtBlockID = par3ItemStack.getItemDamage();
            ...
            par3ItemStack.setItemDamage(lookedAtBlockID);
    ...
    private void onBlockBrokenClientSide(int iBlockID, int iBlockI, int iBlockJ, int iBlockK, int iBlockMetadata)
    {
		...
		{
			mc.thePlayer.exhaustionAddedSinceLastGuiUpdate = true;
		}
    }
