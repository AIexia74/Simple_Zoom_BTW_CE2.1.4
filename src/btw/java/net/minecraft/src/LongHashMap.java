...
public class LongHashMap
{
	...
	private final int defaultSize = 2000;
    private final float percentUseable = 0.75F;
	
    private transient LongHashMapEntry[] hashArray = new LongHashMapEntry[defaultSize];
     ...
     */
    private int capacity = (int)((float) defaultSize * percentUseable );
