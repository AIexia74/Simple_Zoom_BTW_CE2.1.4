...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void renderSky(float par1)
    {
        ...
        else if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            if (CompanionBeaconEffect.companionStrength > 0) {
                this.renderEngine.bindTexture(FakeResourceLocation.unwrap(SkyRenderer.setupCelestialObject(FakeResourceLocation.wrap("/environment/moon_moon_phases.png"))));
            }
            else {
    ...
    public EntityFX doSpawnParticle(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else if ( par1Str.equals( "fccinders" ) )
            {
            	...
            	{
            		this.mc.effectRenderer.addEffect( (EntityFX) (var21 = (EntityFX) EntityList.createEntityOfType(CindersFX.class, this.theWorld, par2, par4, par6)) );
            	}
            }
            // END FCMOD
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var21 = EntityList.createEntityOfType(WhiteSmokeFX.class, theWorld, par2, par4, par6, par8, par10, par12);
                    }
                    else if ( par1Str.equals( "fcwhitecloud" ) )
                    {
                        var21 = EntityList.createEntityOfType(WhiteCloudFX.class, theWorld, par2, par4, par6, par8, par10, par12);
                    }
                    else if ( par1Str.equals( "fcsmallflame" ) )
                    {
                        var21 = EntityList.createEntityOfType(SmallFlameFX.class, theWorld, par2, par4, par6, par8, par10, par12);
                    }
                    else if (par1Str.equals("dripBlood"))
                    {
                        var21 = EntityList.createEntityOfType(EntityDropParticleFX.class, this.theWorld, par2, par4, par6, BTWBlocks.bloodMaterial, 5, 0.8F, 0.0F, 0.0F, 1.0F);
                    }
                    else {
                    	var21 = AddonHandler.spawnCustomParticle(this.theWorld, par1Str, par2, par4, par6, par8, par10, par12);
                    }
                    // END FCMOD
    ...
    public void broadcastSound(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        switch (par1)
        {
            ...
            default:
            	// FCMOD: Code added:            	
            	AddonHandler.clientPlayCustomAuxFX( mc, theWorld, null, par1, par2, par3, par4, par5 );
    ...
    public void playAuxSFX(EntityPlayer par1EntityPlayer, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        switch (par2)
        {
            ...
            default:
            	...
            	AddonHandler.clientPlayCustomAuxFX( mc, theWorld, par1EntityPlayer, par2, par3, par4, par5, par6 );
