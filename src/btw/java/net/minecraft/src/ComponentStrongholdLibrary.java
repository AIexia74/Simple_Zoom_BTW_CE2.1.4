    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            if (this.isLargeRoom)
            {
                ...
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 1, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 2, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 3, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 4, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 5, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 6, 13, par3StructureBoundingBox);
                placeBlockAtCurrentPosition(par1World, BTWBlocks.ladder.blockID, iMetadata, 10, 7, 13, par3StructureBoundingBox);
                byte var8 = 7;
                byte var9 = 7;
