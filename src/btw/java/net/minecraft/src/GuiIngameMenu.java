...
public class GuiIngameMenu extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            case 0:
                // This is a super hacky check for if the player is connected to SP or MP
                boolean hideDifficulty = this.mc.getIntegratedServer() == null;
                this.mc.displayGuiScreen(new GuiOptions(this, this.mc.gameSettings, hideDifficulty));
                break;
