...
public class ModelWolf extends ModelBase
{
    ...
    {
        WolfEntity var5 = (WolfEntity)par1EntityLiving;
        ...
        // FCMOD: Added (client only)
        wolfHeadMain.rotationPointY = 13.5F + ((WolfEntity)par1EntityLiving).getGrazeHeadVerticalOffset(par4) * 5.0F;
        headRotation = ((WolfEntity)par1EntityLiving).getGrazeHeadRotation(par4);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
    {
        ...
        // FCMOD: Added (client only)
        wolfHeadMain.rotateAngleX = headRotation;
        // ENDD FCMOD
    }
}
