...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.buttonGameMode = new GuiButton(2, this.width / 2 - 75, 100, 150, 20, var1.translateKey("selectWorld.gameMode")));
        this.buttonList.add(this.buttonDifficultyLevel = new GuiButton(9, this.width / 2 - 75, 125, 150, 20, var1.translateKey("selectWorld.difficulty")));
    ...
    private void updateButtonText()
    {
        ...
        this.buttonDifficultyLevel.displayString = var1.translateKey("selectWorld.difficulty") + ": " + Difficulties.DIFFICULTY_LIST.get(this.difficultyID).getLocalizedName();
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            else if (par1GuiButton.id == 0)
            {
                ...
                WorldSettings var6 = new WorldSettings(var2, var8, this.generateStructures, this.isHardcore, WorldType.worldTypes[this.worldTypeId], Difficulties.DIFFICULTY_LIST.get(this.difficultyID));
            ...
            {
                if (this.gameMode.equals("survival") && BTWMod.allowHardcore)
                {
                ...
                else if (this.gameMode.equals("hardcore") || this.gameMode.equals("survival"))
                {
                    if (!this.commandsToggled)
                    {
            ...
            else if (par1GuiButton.id == this.buttonDifficultyLevel.id) {
                this.difficultyID++;
                
                if (this.difficultyID >= Difficulties.DIFFICULTY_LIST.size()) {
                    this.difficultyID = 0;
                }
    ...
    private void func_82288_a(boolean par1)
    {
        ...
        this.buttonDifficultyLevel.drawButton = !this.moreOptions;
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        else
        {
            ...
            this.drawString(this.fontRenderer, var4.translateKey("difficulty." + Difficulties.DIFFICULTY_LIST.get(this.difficultyID).NAME + ".description"), this.width / 2 - 90, 147, 10526880);
            this.drawString(this.fontRenderer, var4.translateKey("difficulty." + Difficulties.DIFFICULTY_LIST.get(this.difficultyID).NAME + ".description2"), this.width / 2 - 90, 159, 10526880);
            this.drawString(this.fontRenderer, var4.translateKey("difficulty." + Difficulties.DIFFICULTY_LIST.get(this.difficultyID).NAME + ".description3"), this.width / 2 - 90, 171, 10526880);
        }
