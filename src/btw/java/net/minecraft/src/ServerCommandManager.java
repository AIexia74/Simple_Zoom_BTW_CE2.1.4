...
public class ServerCommandManager extends CommandHandler implements IAdminCommand
{
    public ServerCommandManager()
    {
        ...
        this.registerCommand(new ServerLocCommand());
        ...
        // Client commands are registered ahead of time
        // Server commands are added at registration and so handled separately (due to init order)
