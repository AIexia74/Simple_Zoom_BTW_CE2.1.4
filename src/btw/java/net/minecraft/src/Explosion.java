...
public class Explosion
{
        ...
        if (this.isFlaming)
        {
            ...
            while (var2.hasNext())
            {
                ...
                if ( explosionRNG.nextInt( 3 ) == 0 &&
                     FireBlock.canFireReplaceBlock(worldObj, var3.x, var3.y, var3.z) &&
    ...
    {
    	if (secondaryExplosionList == null )
    	{
            secondaryExplosionList = new ArrayList();
    	}
        ...
        secondaryExplosionList.add(explosion);
    }
    ...
    private void performSecondaryExplosions()
    {
    	if (secondaryExplosionList != null )
    	{
    		Iterator tempIterator = secondaryExplosionList.iterator();
