...
public class ComponentVillageField extends ComponentVillage
{
    ...
    public ComponentVillageField(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
		...
		// Preserves vanilla RNG
        this.secondaryCrop = this.getRandomCrop(par3Random);
        this.secondaryCrop = this.getRandomCrop(par3Random);
        this.secondaryCrop = this.getRandomCrop(par3Random);
        this.secondaryCrop = this.getRandomCrop(par3Random);
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        for (var4 = 1; var4 <= 7; ++var4)
        {
			...
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 4, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 4, 2, var4, par3StructureBoundingBox);
			}
	
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 5, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 5, 2, var4, par3StructureBoundingBox);
			}
	
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 7, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 7, 2, var4, par3StructureBoundingBox);
			}
	
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 8, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 8, 2, var4, par3StructureBoundingBox);
			}
	
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, secondaryCrop, cropGrowth, 10, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7 && secondaryCrop == BTWBlocks.wheatCrop.blockID) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 10, 2, var4, par3StructureBoundingBox);
			}
	
			cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
			placeBlockAtCurrentPosition(par1World, secondaryCrop, cropGrowth, 11, 1, var4, par3StructureBoundingBox);
			if (cropGrowth == 7 && secondaryCrop == BTWBlocks.wheatCrop.blockID) {
				placeBlockAtCurrentPosition(par1World, BTWBlocks.wheatCropTop.blockID, 3, 11, 2, var4, par3StructureBoundingBox);
			}
        	...
        	if ( iAbandonmentLevel > 1 )
            {
				...
				this.placeBlockAtCurrentPosition(par1World, 0, 0, 7, 2, var4, par3StructureBoundingBox);
				this.placeBlockAtCurrentPosition(par1World, 0, 0, 8, 2, var4, par3StructureBoundingBox);
				this.placeBlockAtCurrentPosition(par1World, 0, 0, 10, 2, var4, par3StructureBoundingBox);
				this.placeBlockAtCurrentPosition(par1World, 0, 0, 11, 2, var4, par3StructureBoundingBox);
            }
