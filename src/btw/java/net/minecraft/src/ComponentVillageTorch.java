...
public class ComponentVillageTorch extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        {
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 0, 3, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 1, 3, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 2, 3, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, BTWBlocks.finiteUnlitTorch.blockID, 8, 1, 3, -1, par3StructureBoundingBox);
        }
        return true;
    }
