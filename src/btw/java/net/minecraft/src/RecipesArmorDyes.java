            ...
            if (var8 != null)
            {
                ...
                else
                {
                    ...
                    if (MinecraftServer.getIsServer()) {
                        ...
                        var14 = ColorizeEntity.getArmorDyeColor(EntitySheep.fleeceColorTable[BlockCloth.getBlockFromDye(var8.getItemDamage())],
                                BlockCloth.getBlockFromDye(var8.getItemDamage()));
                    }
