...
public class Minecraft implements Runnable, IPlayerUsage
{
	...
	public static final boolean isRunningOnMac = getOs() == EnumOS.MACOS;    /** A 10MiB preallocation to ensure the heap is reasonably sized. */
    ...
    public Minecraft(int par3, int par4, boolean par5, String gameDir)
    {
        ...
        field_94139_O = new LogAgent("Minecraft-Client", " [CLIENT]", (new File(getMinecraftDir(), "output-client.log")).getAbsolutePath());
        StatList.nopInit();
