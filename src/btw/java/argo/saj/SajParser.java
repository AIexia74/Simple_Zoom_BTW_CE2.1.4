...
{
    public void parse(Reader par1Reader, JsonListener par2JsonListener) throws IOException, InvalidSyntaxException
    {
    ...
    private void arrayString(PositionTrackingPushbackReader par1PositionTrackingPushbackReader, JsonListener par2JsonListener) throws IOException, InvalidSyntaxException
    {
    ...
    private void objectString(PositionTrackingPushbackReader par1PositionTrackingPushbackReader, JsonListener par2JsonListener) throws IOException, InvalidSyntaxException
    {
        char var3 = (char)this.readNextNonWhitespaceChar(par1PositionTrackingPushbackReader);
    ...
    private void aFieldToken(PositionTrackingPushbackReader par1PositionTrackingPushbackReader, JsonListener par2JsonListener) throws IOException, InvalidSyntaxException
    {
        char var3 = (char)this.readNextNonWhitespaceChar(par1PositionTrackingPushbackReader);
    ...
    private void aJsonValue(PositionTrackingPushbackReader par1PositionTrackingPushbackReader, JsonListener par2JsonListener) throws IOException, InvalidSyntaxException
    {
        char var3 = (char)this.readNextNonWhitespaceChar(par1PositionTrackingPushbackReader);
    ...
    private String stringToken(PositionTrackingPushbackReader par1PositionTrackingPushbackReader) throws IOException, InvalidSyntaxException
    {
        StringBuilder var2 = new StringBuilder();
        char var3 = (char)par1PositionTrackingPushbackReader.read();
