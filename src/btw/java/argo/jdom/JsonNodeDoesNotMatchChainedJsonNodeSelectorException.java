...
public final class JsonNodeDoesNotMatchChainedJsonNodeSelectorException extends JsonNodeDoesNotMatchJsonNodeSelectorException
{
    ...
    static JsonNodeDoesNotMatchJsonNodeSelectorException func_74701_a(Functor par0Functor)
    {
        return new JsonNodeDoesNotMatchChainedJsonNodeSelectorException(par0Functor, new LinkedList());
    }

    static JsonNodeDoesNotMatchJsonNodeSelectorException func_74699_a(JsonNodeDoesNotMatchChainedJsonNodeSelectorException par0JsonNodeDoesNotMatchChainedJsonNodeSelectorException, JsonNodeSelector par1JsonNodeSelector)
    {
    ...
    static JsonNodeDoesNotMatchJsonNodeSelectorException func_74698_b(JsonNodeDoesNotMatchChainedJsonNodeSelectorException par0JsonNodeDoesNotMatchChainedJsonNodeSelectorException, JsonNodeSelector par1JsonNodeSelector)
    {
