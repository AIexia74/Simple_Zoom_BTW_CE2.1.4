...
public class RottenArrowRenderer extends Render
{
    ...
    public void doRender(Entity entity, double d, double d1, double d2,
                         float f, float f1)
    {
        renderArrow((RottenArrowEntity)entity, d, d1, d2, f, f1);
    }
    
    //************* Class Specific Methods ************//
    
    public void renderArrow(RottenArrowEntity entityarrow, double d, double d1, double d2,
                            float f, float f1)
    {
