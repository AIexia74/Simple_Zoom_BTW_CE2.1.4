...
public class InfiniteArrowRenderer extends Render
{
    public InfiniteArrowRenderer()
    {
    }
    ...
    public void doRender(Entity entity, double d, double d1, double d2,
                         float f, float f1)
    {
        renderArrow((InfiniteArrowEntity)entity, d, d1, d2, f, f1);
    }
    
    //************* Class Specific Methods ************//
    
    public void renderArrow(InfiniteArrowEntity entityarrow, double d, double d1, double d2,
                            float f, float f1)
    {
