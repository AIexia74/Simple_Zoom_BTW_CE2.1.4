...
public class DynamiteEntity extends Entity
	implements IProjectile, EntityWithCustomPacket
{
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setInteger( "m_iFuse", fuse);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        fuse = nbttagcompound.getInteger( "m_iFuse" );
    }
    ...
    public void onUpdate()
    {
        ...
        {
            if ( iInBlockID == Block.fire.blockID || iInBlockID == BTWBlocks.stokedFire.blockID )
            {
            	fuse = TICKS_TO_DETONATE;
    ...
    {    	
        ...
        try
        {
	        dataStream.writeInt( BTWPacketManager.DYNAMITE_SPAWN_PACKET_ID);
    ...
    private void spawnRedneckFish(int i, int j, int k)
    {
        ...
        {
        	entityItem = (EntityItem) EntityList.createEntityOfType(FloatingItemEntity.class, worldObj, (float)i + 0.5F, (float)j + 0.5F, (float)k + 0.5F, stack );
        }
    ...
    {
    	ItemUtils.ejectSingleItemWithRandomVelocity(worldObj, (float)posX, (float)posY, (float)posZ, BTWItems.dynamite.itemID, 0);
