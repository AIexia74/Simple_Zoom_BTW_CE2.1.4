...
{
    private static final int[] itemDrops = new int[] {
    	BTWItems.witchWart.itemID,
    ...
    public WitchEntity(World world )
    {
        ...
        tasks.addTask( 2, new SimpleWanderBehavior( this, moveSpeed ) );
    }
    ...
    protected void dropFewItems( boolean bKilledByPlayer, int iLootingModifier )
    {
        ...
        {
            int iItemID = itemDrops[rand.nextInt(itemDrops.length)];
