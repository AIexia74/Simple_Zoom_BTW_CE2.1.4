...
{
    private int jumpCountdown = 0; // duplicate of parent slimeJumpDelay due to it being private
    
    public SlimeEntity(World world )
    {
        super( world );

        jumpCountdown = getJumpDelay();
    }
    ...
    {
        return (EntitySlime) EntityList.createEntityOfType(SlimeEntity.class, worldObj);
    }
