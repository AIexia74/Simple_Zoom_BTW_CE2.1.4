...
public class JungleTreeGenerator extends WorldGenerator
{
    ...
    public JungleTreeGenerator(boolean par1, int par2, int par3, int par4)
    {
        super(par1);
        field_48195_a = par2;
        woodMetadata = par3;
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        // FCMOD Soil
        if (!TreeUtils.canSaplingGrowOnBlock(par1World, par3, par4 - 1, par5) ||
        	par4 >= 256 - i - 1)
    	// END FCMOD
        {
            return false;
