...
public class BloodWoodLeavesBlock extends LeavesBlock
{
    ...
    {
    	return BTWBlocks.aestheticVegetation.blockID;  // for bloodwood sapling
    }
    ...
    public void harvestBlock( World world, EntityPlayer player, int i, int j, int k, int iMetadata )
    {
        ...
        {
            dropBlockAsItem_do( world, i, j, k, new ItemStack( BTWBlocks.bloodWoodLeaves.blockID, 1, iMetadata & 3 ) );
    ...
    {
    	return AestheticVegetationBlock.SUBTYPE_BLOOD_WOOD_SAPLING;
    }
    
	@Override
    protected void dropBlockAsItem_do( World world, int i, int j, int k, ItemStack itemStack )
    {
		if ( itemStack.itemID == BTWBlocks.aestheticVegetation.blockID &&
			itemStack.getItemDamage() == AestheticVegetationBlock.SUBTYPE_BLOOD_WOOD_SAPLING)
		{		
                ...
                for(int l1 = -byte0; l1 <= byte0; l1++)
                {
                    for(int k2 = -byte0; k2 <= byte0; k2++)
                    {
                        for(int i3 = -byte0; i3 <= byte0; i3++)
                        {
                            ...
                            if ( k3 == BTWBlocks.bloodWoodLeaves.blockID )
                            {
